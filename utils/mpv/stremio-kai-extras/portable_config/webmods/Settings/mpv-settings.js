...
(function () {
  ...
  function injectSettings(targetSection) {
    ...
    // Display/Anime sections go between Audio and "Controls"; Smart Track items go
    // inside "Audio" and "Subtitles"; Skip items go inside "Advanced".

    const allLabels = Array.from(document.querySelectorAll(".label-FFamJ"));

    // "Audio"/"Subtitles"/"Advanced" are category labels inside the Player section
    // (not the section title itself) -- find their section-category-container.
  ...
  // Also expose to window for mpv-bridge.js
  ...
  window.addEventListener("storage", (e) => {
    if (Object.values(STORAGE_KEYS).includes(e.key)) {
      ...
      if (settingsContent) {
        // No visual toggle re-sync here; mpv-bridge.js reads from storage directly.
        console.log(
