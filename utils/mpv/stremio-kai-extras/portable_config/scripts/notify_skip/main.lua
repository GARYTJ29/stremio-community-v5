...
-- Gamepad connect/disconnect, forwarded by gamepad.cpp's injected JS, so the
-- skip button hint can switch between "Press Tab" and "RB+A".
mp.register_script_message("gamepad-active", function(value)
    state.ui_state.gamepad_active = (value == "true")
end)
